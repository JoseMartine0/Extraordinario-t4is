...
public class Configuracion extends WsConfigurerAdapter {
    ...
    @Bean
    public ServletRegistrationBean<MessageDispatcherServlet> MessageDispatcherServerlet( ApplicationContext applicationContext) {
        ...
        return new ServletRegistrationBean<>(serverlet, "/ws/*");
    }
